-- 032_maintenance_actions_and_parts_usage.up.sql
-- Massnahmen-Verlauf und Ersatzteil-Merkliste fuer Wartungsauftraege.
-- Das bestehende "notes"-Feld (Abschluss-Notiz) bleibt unveraendert bestehen;
-- die Massnahmen sind ein zusaetzlicher, strukturierter Verlauf mit mehreren Eintraegen.
